...
pub fn draw_hud(
    ...
    let health_bar_fill = contexts.add_image(bevy_egui::EguiTextureHandle::Strong(
        asset_server.load("health_bar_fill.png").clone(),
    ));
    let health_bar_border = contexts.add_image(bevy_egui::EguiTextureHandle::Strong(
        asset_server.load("health_bar_border.png").clone(),
    ));
...
pub fn draw_xp_bar(
    ...
    let width = windows.single().expect("Window not found").width();
...
pub fn draw_revenge_bar(
    ...
    let width = windows.single().unwrap().width();
